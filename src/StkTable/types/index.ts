...
/**
 * 自定义渲染单元格 (Svelte Component)
 */
export type CustomCell<T extends CustomCellProps<U> | CustomHeaderCellProps<U>, U extends Record<string, any>> = Component<Partial<T>> | string;
...
export type ColKeyGen = (col: StkTableColumn<any>) => UniqKey;
