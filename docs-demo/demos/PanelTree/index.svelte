<script lang="ts">
    ...
    async function updateRow() {
        ...
        await tick();
        stkTableRef?.setHighlightDimRow([row.key]);
    }
</script>

<div>
    <button class="btn" onclick={updateRow}>Update Row</button>
    <StkTable
...
<style lang="less">
div :global(.panel-title .table-cell-wrapper) {
    font-weight: bold;
    overflow: initial;
}

div :global(.panel-header-row) {
