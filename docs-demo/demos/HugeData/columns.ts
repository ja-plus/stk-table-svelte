...
import SourceOrExpandCell from './custom-cells/SourceOrExpandCell.svelte';
import BuyVolFilterHeaderCell from './custom-cells/BuyVolFilterHeaderCell.svelte';
...
export const columns: () => StkTableColumn<DataType>[] = () => {
    ...
    return [
        { type: 'seq', dataIndex: 'seq' as any, title: t('seq'), fixed: 'left', width: 70 },
        {
            ...
            align: 'center',
            fixed: 'left',
            // vue 版为 h() 分支渲染函数，svelte 版拆为 SourceOrExpandCell 组件
            customCell: SourceOrExpandCell,
        },
        {
            dataIndex: 'code',
            title: t('code'),
