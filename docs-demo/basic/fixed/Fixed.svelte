<script lang="ts">
    ...
    let fixedColShadow = $state(false);
...
<CheckItem bind:checked={fixedColShadow} text={t('showFixedShadow')}></CheckItem>
<StkTable {fixedColShadow} {columns} {dataSource}></StkTable>
