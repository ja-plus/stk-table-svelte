...
<button class="btn" onclick={handleSortDesc}>Desc</button>
<button class="btn" onclick={handleSortAsc}>Asc</button>
<StkTable bind:this={stkTableRef} style="height: 200px" rowKey="key" {columns} {dataSource}></StkTable>
