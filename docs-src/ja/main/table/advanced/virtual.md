...
```
<demo svelte="advanced/virtual/VirtualY.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/advanced/virtual/VirtualY.svelte"></demo>
...
```svelte
<StkTable virtualX></StkTable>
```
<demo svelte="advanced/virtual/VirtualX.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/advanced/virtual/VirtualX.svelte"></demo>
