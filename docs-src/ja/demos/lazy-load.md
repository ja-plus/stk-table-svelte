...
<demo svelte="demos/LazyLoad/index.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/demos/LazyLoad/index.svelte"></demo>
...
async function loadDataPage(page: number) {
  ...
  if (!tableData[startIndex]?.__placeholder) return;
