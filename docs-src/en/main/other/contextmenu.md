...
StkTableSvelte does not have a built-in context menu, so you need to integrate a third-party library.
...
<demo svelte="other/contextmenu/ContextMenu.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/other/contextmenu/ContextMenu.svelte"></demo>
