...
```
<demo svelte="advanced/custom-sort/CustomSort/index.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/advanced/custom-sort/CustomSort/index.svelte"></demo>
...
```ts
import { tableSort, insertToOrderedArray } from 'stk-table-svelte';
```
### tableSort
#### Usage Scenario
 ...
 * @param sortConfig SortConfig reference https://github.com/ja-plus/stk-table-svelte/blob/master/src/StkTable/types/index.ts
...
<demo svelte="advanced/custom-sort/InsertSort.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/advanced/custom-sort/InsertSort.svelte"></demo>
