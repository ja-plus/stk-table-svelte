...
## demo
<demo svelte="basic/row-cell-mouse-event/RowCellHoverSelect.svelte" github="https://github.com/ja-plus/stk-table-svelte/tree/master/docs-demo/basic/row-cell-mouse-event/RowCellHoverSelect.svelte"></demo>
